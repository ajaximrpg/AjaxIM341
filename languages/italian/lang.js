...
Languages.onLoad('italian', {
   ...
   'registerUsernameBad': 'Il nome utente pu&uacute; contenere solo lettere e numeri, _,<br />e deve essere lungo da 3 a 16 caratteri.',
   ...
   'registerFailed': 'Errore nella registrazione! riprovare pi&uacute; tardi.',
   'registerPasswordsMatch': 'Le password non coincidono!',
   
   // Chatrooms
   'hasJoined': '&eacute; entrato.',
   'hasLeft': '&eacute; uscito.',
   
   // IMs
   'notifySentButOffline': 'Nota: Questo utente &eacute; attualmente scollegato, ma ricever&aacute; il messaggio quanto entrer&aacute;.',
   'errorNotLoggedIn': 'Errore: Il messaggio non pu&oacute; essere inviato perch&eacute; il destinatario &eacute; scollegato.',
   'errorMsgTooLong': 'Errore: Il messaggio &eacute; troppo lungo.',
   ...
   'invalidRoom': 'Il nome del canale inserito &eacute; invalido.',
   ...
   'changeSuccess': "La password &eacute; stata aggiornata con successo!\nPrego effetuare nuovamente il login.",
   'currentPassInvalid': 'La "Password corrente" inserita &eacute; errata.',
   'changePasswordShort': 'La password deve avere da 6 a 20 caratteri!',
   'changeFailed': 'Problema durante il cambio della password, riprovare pi&uacute; tardi.',
   ...
   'newPasswordEmailed': 'La nuova password &eacute; stata inviata a %1',
   'noEmailOnRecord': 'Non c\'&eacute; nessuna email associata con utente.',
   'problemResetting': 'Avvenuto un errore durante il reset della password.<br />Riprovare pi&uacute; tardi.',
   ...
   'admin-lastActive': 'Ultima attivit&aacute;',
   'admin-status': 'Status',
   'admin-kick': 'Kick',
   'admin-ban': 'Ban',
   'admin-unban': 'Unban',
